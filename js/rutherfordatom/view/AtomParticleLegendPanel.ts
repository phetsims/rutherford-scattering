...
const electronEnergyLevelStringProperty = RutherfordScatteringFluent.electronEnergyLevelStringProperty;
const nucleusStringProperty = RutherfordScatteringFluent.nucleusStringProperty;
