...
define( function( require ) {
   ...
   * @constructor
   */
  function RutherfordNucleusAtom( protonCountProperty, position, boundingWidth, options ) {
  ...
  rutherfordScattering.register( 'RutherfordNucleusAtom', RutherfordNucleusAtom );

  return inherit( Atom, RutherfordNucleusAtom, {
